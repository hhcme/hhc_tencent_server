...
- Tencent Cloud adapter with TC3 request signing plus Region, CVM instance query parsing, Cloud Monitor CPU metric query support, and VPC security group/rule read support.
- Tencent Cloud security group foundations with VPC security group/rule read APIs and read-only workspace inspection for the linked account and region.
