...
- Windows native Phase 8 solution skeleton with WinUI 3, Windows App SDK, .NET, CI-covered SQLite/core tests, Windows Credential Manager boundaries, password/private-key server CRUD flows, host-key trust, SSH adapter foundations, and an opt-in Windows real SSH integration test entrypoint.
