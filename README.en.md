...
- Windows native Phase 8 solution skeleton with WinUI 3, Windows App SDK, .NET, CI-covered SQLite/core tests, Windows Credential Manager boundaries, host-key trust, and SSH adapter foundations.
