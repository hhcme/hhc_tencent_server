...
- Added macOS remote transfer finished-history cleanup so succeeded, failed, cancelled, and interrupted transfer records can be cleared while pending/running jobs remain active.
